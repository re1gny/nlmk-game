...
export function Hook(props) {
  ...
  return (
    <svg className={className} width="22" height="89" viewBox="0 0 22 89" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M2.20933 27.3118C1.84455 23.7735 4.62063 20.6965 8.1777 20.6965H14.3048C17.8374 20.6965 20.6055 23.7333 20.2791 27.2509L18.4973 46.4547C18.211 49.5404 15.6219 51.9004 12.523 51.9004H10.1575C7.082 51.9004 4.50449 49.5749 4.18911 46.5157L2.20933 27.3118Z" fill="#039CFD" stroke="#003399" stroke-width="2"/>

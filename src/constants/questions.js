...
export const questions = {
    [TRACKS.UNSPECIFIED] : {
        getQuestion: () => (
            <Text>
                Задумываешься о <b>перспективном будущем</b> и выбираешь сферу 
                для <b>старта карьеры?</b> Посмотри свои <b>возможности с 
                Группой НЛМК</b> — международной металлургической компанией!
                <br/>
                <b>Выбирай свою область:</b>
            </Text>
        ),
